...
export default function AboutPage() {
  ...
  return (
    <main className="about-page">
      <header className="about-header"><Link className="brand display" href="/" aria-label="Sago home"><Image className="sago-logo" src="/assets/LOGO.png" alt="Sago" width={48} height={48} /></Link><nav aria-label="About navigation"><Link href="/">Home</Link><Link href="/collection">Collection</Link><a className="active" href="#story">Our story</a><Link href="/#shop">Find Sago</Link></nav><Link className="about-header__cta" href="/#shop">Shop nearby <ArrowRight size={14} /></Link></header>
