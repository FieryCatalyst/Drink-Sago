...
export default function AccessibilityPage() {
  return <LegalPage title="Accessibility" intro="We want sago.world to be usable by as many people as possible, including people who use keyboards, screen readers, magnification or reduced motion." sections={[
    ...
    { title: "Feedback", children: <><p>Tell us what blocked you, which page you were using and what assistive technology or browser you used. Contact <a href="mailto:hello@sago.world">hello@sago.world</a> and we will consider the issue for improvement.</p></> },
  ]} />;
}
